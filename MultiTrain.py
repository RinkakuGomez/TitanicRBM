...
if __name__== '__main__':
    ...
    i = 1 
    name_dataSet = 'datasets/Titanic1300.csv'
    ...
    for n_hidden in arr_hidden:
        for learning_rate in arr_LR:
            for batch_size in arr_BatchSize:
                ...
                prueba = model.TitanicRBM.TitanicRBM(nameDataset = name_dataSet,n_epoch=num_epoch, lr=learning_rate, bs=batch_size, num_visible=n_visible, num_hidden=n_hidden, num_k=k, arr_fieldString=arr_fString)
